# %%
"""
In practice the simulation runs were partitioned to run on the cloud.
The following code would loop through all models and run them, given adequate resources.
However, it would require tens of days, so the user is advised to only use the code to understand the methodology.
"""
...
def ffnn_model(name, input_shape, depth, nodes_per_layer, normaliser, dropout):
...
def train_eval_model(representation, X_train, y_train, X_val, y_val, X_test, savedir, model_name):
    ...
    if repr_type == 'DL':
        ...
        model = ffnn_model(name=model_name, input_shape=X_train.shape[1],
            depth=depth, nodes_per_layer=nodes_per_layer, normaliser=normaliser, dropout=dropout)
        model.compile(
...
representations = {
    ...
    # No dropout
    # ----------------------------------------------------------------------------------------------------------------
    'ffnn_1x10_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 10, 'schedule': schedule2, 'dropout': False},
    'ffnn_1x20_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 20, 'schedule': schedule2, 'dropout': False},
    'ffnn_1x50_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 50, 'schedule': schedule2, 'dropout': False},
    'ffnn_1x75_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 75, 'schedule': schedule2, 'dropout': False},
    'ffnn_1x100_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 100, 'schedule': schedule2, 'dropout': False},

    'ffnn_2x10_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 10, 'schedule': schedule2, 'dropout': False},
    'ffnn_2x20_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 20, 'schedule': schedule2, 'dropout': False},
    'ffnn_2x50_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 50, 'schedule': schedule2, 'dropout': False},
    'ffnn_2x75_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 75, 'schedule': schedule2, 'dropout': False},
    'ffnn_2x100_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 100, 'schedule': schedule2, 'dropout': False},

    'ffnn_3x10_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 10, 'schedule': schedule2, 'dropout': False},
    'ffnn_3x20_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 20, 'schedule': schedule2, 'dropout': False},
    'ffnn_3x50_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 50, 'schedule': schedule2, 'dropout': False},
    'ffnn_3x75_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 75, 'schedule': schedule2, 'dropout': False},
    'ffnn_3x100_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 100, 'schedule': schedule2, 'dropout': False},
    # Same but with dropout
    # Note that dropout uses a different schedule, with a smaller learning rate
    # ----------------------------------------------------------------------------------------------------------------
    'ffnn_1x10_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 10, 'schedule': schedule1, 'dropout': True},
    'ffnn_1x20_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 20, 'schedule': schedule1, 'dropout': True},
    'ffnn_1x50_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 50, 'schedule': schedule1, 'dropout': True},
    'ffnn_1x75_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 75, 'schedule': schedule1, 'dropout': True},
    'ffnn_1x100_sch2': {'repr_type': 'DL', 'depth': 1, 'nodes_per_layer': 100, 'schedule': schedule1, 'dropout': True},

    'ffnn_2x10_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 10, 'schedule': schedule1, 'dropout': True},
    'ffnn_2x20_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 20, 'schedule': schedule1, 'dropout': True},
    'ffnn_2x50_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 50, 'schedule': schedule1, 'dropout': True},
    'ffnn_2x75_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 75, 'schedule': schedule1, 'dropout': True},
    'ffnn_2x100_sch2': {'repr_type': 'DL', 'depth': 2, 'nodes_per_layer': 100, 'schedule': schedule1, 'dropout': True},

    'ffnn_3x10_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 10, 'schedule': schedule1, 'dropout': True},
    'ffnn_3x20_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 20, 'schedule': schedule1, 'dropout': True},
    'ffnn_3x50_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 50, 'schedule': schedule1, 'dropout': True},
    'ffnn_3x75_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 75, 'schedule': schedule1, 'dropout': True},
    'ffnn_3x100_sch2': {'repr_type': 'DL', 'depth': 3, 'nodes_per_layer': 100, 'schedule': schedule1, 'dropout': True},
}
...
for data_config in data_configs.keys():
    ...
    for representation in representations.keys():
        ...
        if repr_type == 'ML':
            ...
            if data_config == 'A':
                continue # config A is not used with deep learning models.
            else:
                dropout = representations[representation]['dropout']
                if dropout == False:
                    cell_config = 'cells_together'
